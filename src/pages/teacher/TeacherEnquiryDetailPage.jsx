...
// Status config
const statusConfig = {
  New:       { bg: '#dbeafe', color: '#1d4ed8', dot: '#3b82f6', gradient: 'linear-gradient(135deg, #3b82f6, #1d4ed8)' },
...
// Info Row Component
function InfoRow({ label, value, icon, color = '#1e293b' }) {
...
export default function EnquiryDetailPage() {
  ...
  const hasPermission = profile?.permissions?.canManageEnquiries === true;
  ...
  if (!hasPermission) {
    return <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center', maxWidth: 400, padding: 32, background: '#fff', borderRadius: 16, border: '1.5px solid #E9ECF0' }}>
        ...
        <p style={{ fontSize: 13, color: '#64748B', marginBottom: 20 }}>You don't have permission to manage enquiries.</p>
    ...
    return (
      <div style={{ 
        ...
        <div style={{ textAlign: 'center', background: 'white', padding: '48px 32px', borderRadius: '24px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)', maxWidth: '480px', width: '100%' }}>
          ...
          <h2 style={{ fontSize: '22px', fontWeight: '900', color: '#1e293b', marginBottom: '8px' }}>Error Loading Enquiry</h2>
          <p style={{ fontSize: '14px', color: '#64748b', marginBottom: '24px' }}>{error || 'Enquiry not found'}</p>
          <button 
            onClick={() => navigate('/teacher/manage-enquiries')}
            style={{ 
              padding: '14px 28px', 
  ...
  const typeConfig = {
    child: { icon: '🧒', label: 'Child Enquiry', gradient: 'linear-gradient(135deg, #E82928, #F28E3A)' },
    job: { icon: '💼', label: 'Job Enquiry', gradient: 'linear-gradient(135deg, #8B5CF6, #6D28D9)' },
    both: { icon: '🎯', label: 'Child + Job Enquiry', gradient: 'linear-gradient(135deg, #E82928, #8B5CF6)' },
    course: { icon: '📚', label: 'Course Enquiry', gradient: 'linear-gradient(135deg, #10B981, #059669)' }
  };
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div>
                <h1 style={{ fontSize: '20px', fontWeight: '900', color: '#1e293b', margin: 0 }}>Enquiry Details</h1>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <InfoCard icon="📞" title="Contact Information">
                <InfoRow label="Mobile" value={enquiry.mobile} icon="📱" color="#1e293b" />
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <InfoCard icon="📝" title="Admin Notes">
                <div style={{ 
                  ...
                  borderRadius: '10px',
                  fontSize: '14px', 
                  color: enquiry.adminNotes ? '#1e293b' : '#94a3b8', 
                  fontWeight: '600',
                  lineHeight: '1.6'
                }}>
