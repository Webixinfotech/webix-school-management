...
import {
  ...
  PartyPopper, CalendarDays, ChevronRight
} from 'lucide-react';
...
const getRoleBadge = (role) => {
  if (role === 'student')       return { label: 'Student',  bg: 'bg-primary/10 text-primary border border-primary/50',   icon: GraduationCap };
...
const BirthdaysPage = () => {
  ...
  const summaryCards = [
    ...
    { label: 'Students', count: counts.student, icon: GraduationCap, gradient: 'from-blue-500 to-indigo-600',   bg: 'bg-primary/10 border-primary/50' },
