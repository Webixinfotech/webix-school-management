    ...
    <div className="min-h-screen bg-[#F8FAFC] py-16 px-4 sm:px-6 lg:px-8 font-['Inter',sans-serif]">
      ...
      <div className="max-w-7xl mx-auto pt-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-[#0C2A47] font-['Outfit',sans-serif]">
          ...
          <div className="mt-8 flex justify-center gap-2">
            <div className="h-1.5 w-24 bg-[#E2B94D] rounded-full"></div>
            <div className="h-1.5 w-12 bg-[#0C2A47] rounded-full opacity-50"></div>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="p-6 sm:p-8 flex-1 flex flex-col relative z-10 transition-colors duration-300"
                  ...
                  {/* Program Name */}
                  <h3 className="text-xl sm:text-2xl font-extrabold text-[#0C2A47] transition-colors font-['Outfit',sans-serif]">
                    {program.name}
                  </h3>
        ...
        <div className="mt-24 text-center mb-12">
          <div className="inline-block bg-gradient-to-r from-[#0C2A47] to-[#081A2E] p-1 rounded-[2rem] shadow-2xl">
            <div className="bg-[#0C2A47] rounded-[1.8rem] px-8 py-10 sm:px-16 sm:py-12 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-64 h-64 bg-[#E2B94D] rounded-full mix-blend-overlay filter blur-3xl opacity-20 transform translate-x-1/2 -translate-y-1/2"></div>
              <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#E2B94D] rounded-full mix-blend-overlay filter blur-3xl opacity-20 transform -translate-x-1/2 translate-y-1/2"></div>
              
              <h2 className="text-2xl sm:text-4xl font-extrabold text-white relative z-10 font-['Outfit',sans-serif]">
                Ready to Join Us?
              </h2>
              <p className="mt-4 text-[#E2B94D] text-sm sm:text-base max-w-xl mx-auto font-medium tracking-wide relative z-10">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                <Link
                  to="/admission"
                  className="inline-flex items-center justify-center px-8 py-4 bg-[#E2B94D] text-[#0C2A47] font-bold rounded-xl hover:bg-white hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                >
                  Admission Process
                </Link>
                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center px-8 py-4 bg-transparent border-2 border-[#E2B94D] text-[#E2B94D] font-bold rounded-xl hover:bg-[#E2B94D] hover:text-[#0C2A47] hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                >
                  Contact Us
                </Link>
              </div>
