      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 lg:h-24">
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `px-5 py-2.5 rounded-full text-[15px] font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary ${
                        isActive 
                          ? 'bg-primary/10 text-primary shadow-[inset_0_0_0_1px_rgba(15,76,92,0.1)]' 
          ...
          <div className="flex items-center gap-3">
            <Link 
              to="/enquiry" 
              className="hidden sm:inline-flex bg-accent hover:bg-[#b5952f] text-primary px-6 py-2.5 rounded-full font-bold text-[15px] transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent shadow-[0_4px_14px_rgba(212,175,55,0.3)] hover:shadow-[0_6px_20px_rgba(212,175,55,0.4)] transform hover:-translate-y-0.5"
